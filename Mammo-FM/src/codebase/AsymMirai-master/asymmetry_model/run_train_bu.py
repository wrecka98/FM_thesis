...
#      chk_pt="/restricted/projectnb/batmanlab/ayak/PhD/Breast-CLIP/src/codebase/outputs/img_text_embed_bumc_clip/b5_detector_no_downstream_no_birads_prompt_period_no_cancer_no_ethnicity_n_modernbert_2048/checkpoints/fold_0/model-best.tar",
#      batch_size=30,
#      lr=0.005,
#      use_addon_layers=False,
#      use_stretch_matrix=True,
